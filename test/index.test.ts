    ...
    expect(processTheme(theme)).toMatchInlineSnapshot(`
      {
        ".dark": {
          ...
          "--btn-background": "hsl(0 0% 100%)/* --background */",
          "--btn-primary": "hsl(240 5.9% 10%)/* --primary */",
          "--btn-primary-foreground": "hsl(0 0% 98%)/* --primary-foreground */",
          "--btn-primary-hover": "hsl(240 5.9% 10% / 90%)/* --btn-primary -> --primary */",
          "--primary": "0 0% 98%",
